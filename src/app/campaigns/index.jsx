...
export default function WireframeCampaigns1OnePage() {
  return (
    ...
    //               size="xs"
    //               as="p"
    //               className="!text-[6.93px] !text-yellow-900"
    //             >
    ...
    //                 size="s"
    //                 as="p"
    //                 className="!text-[9.35px] !text-gray-500"
    //               >
    //                 Campaigns
    //               </Text>
    //               <Img
    ...
    //                       size="s"
    //                       as="p"
    //                       className="!text-[9.35px] !text-indigo-300"
    //                     >
    //                       Toocan.io - test
    //                     </Text>
    //                     <Img
    ...
    //             size="s"
    //             as="p"
    //             className="self-start !text-[9.35px] !text-blue_gray-100"
    //           >
