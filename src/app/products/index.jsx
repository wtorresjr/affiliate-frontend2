          ...
          <div className="flex items-center justify-between gap-5 md:flex-col">
            ...
            <div className="flex flex-col items-start">
              ...
              <Text
                size="8xl"
                as="p"
                className="mt-[19px] !text-indigo-300 underline"
              >
                ORCA Bulk Flip Flops For Wedding Guests (WHITE) | 52 Pack
                Whitevv
              </Text>
              <Text size="3xl" as="p">
                B07XGMQ734 - SILV LLC
              ...
              <Text
                size="8xl"
                as="p"
                className="mt-5 !text-indigo-300 underline"
              >
                ORCA Bulk Flip Flops For Wedding Guests (WHITE) | 52 Pack
                Whitevv
              </Text>
        ...
        <div className="absolute left-[0.00px] top-[0.00px] m-auto h-[175px] w-[23%] bg-[url(/images/img_group_white_a700_313x228.svg)] bg-cover bg-no-repeat px-6 pb-[17px] pt-3.5 sm:px-5">
          ...
          <div className="absolute bottom-0 left-0 right-0 top-0 m-auto flex h-max w-[88%] flex-col items-start">
            ...
            <Text
              size="5xl"
              as="p"
              className="mt-3.5 !text-[17.99px] !text-red-500_01"
            >
              Clear Selection
            </Text>
          </div>
