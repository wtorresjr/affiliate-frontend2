...
import { TextArea, Text, Img, Button, Heading } from "../../components";
        ...
        <div className="flex items-start gap-[38px] md:flex-col">
          ...
          <div className="flex w-[22%] flex-col items-center gap-[219px] rounded-[21px] bg-white-A700 px-[49px] pb-[54px] pt-[51px] md:w-full md:gap-[164px] md:p-5 sm:gap-[109px]">
            <div className="flex flex-col items-center gap-[25px] self-stretch">
              <Img src="img_group_black_900.svg" width={206} height={206} alt="image" className="h-[206px] w-[206px]" />
              <Heading size="s" as="h1" className="!text-[40.71px] !text-black-900">
                Mike Wazowski
              </Heading>
              <div className="flex w-[68%] flex-col md:w-full">
                <div className="flex justify-between gap-5">
                  <Img src="img_facebook.svg" width={33} height={33} alt="facebook" className="h-[33px] w-[33px]" />
                  <Img src="img_info.svg" width={33} height={33} alt="info" className="h-[33px] w-[33px]" />
                  <Img
              ...
              <div className="flex">
                <div className="flex items-center gap-4">
                  <div className="flex flex-col items-center gap-6">
                    <Img src="img_call_gray_500.svg" width={20} height={20} alt="call" className="h-[20px] w-[20px]" />
                    <Img src="img_lock_gray_500.svg" width={21} height={16} alt="lock" className="h-[16px] w-full" />
                    <Img src="img_globe.svg" width={21} height={20} alt="globe" className="h-[20px] w-full md:h-auto" />
                  </div>
                  <div className="flex flex-col items-start gap-[17px]">
                    <Text size="8xl" as="p" className="!text-[20.38px] !text-gray-500">
                      (205) 555-201
                    </Text>
                    <Text size="8xl" as="p" className="!text-[20.38px] !text-gray-500">
                      mike@yahoo.com
          ...
          <div className="flex flex-1 flex-col items-end gap-[53px] md:self-stretch md:p-5 sm:gap-[26px]">
            <div className="flex w-[26%] items-center gap-[19px] md:w-full">
            ...
            <div className="flex flex-col items-start self-stretch">
              <div className="flex gap-[35px] self-stretch md:flex-col">
                {[...Array(3)].map((d, index) => (
                  <WireframeAffiliatesTwoSalessummary key={"salessummary" + index} className="gap-[5px] md:p-5" />
                ))}
              </div>
              ...
              <Text size="9xl" as="p" className="mt-[31px] !text-[22.82px]">
                ...
                <span className="text-[15px] text-gray-500">(Internal Use Only)</span>
              </Text>
              <TextArea
                shape="round"
                name="group545"
