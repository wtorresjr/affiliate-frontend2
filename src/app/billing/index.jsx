    ...
    return [
      table1ColumnHelper.accessor("month", {
        ...
        header: (info) => (
          <Text
            as="p"
            className="px-px pb-2.5 pt-px !text-[13.69px] !text-gray-500"
          >
            Month
          </Text>
        ),
            ...
            <div className="flex gap-[22px] md:flex-col">
              <div className="flex rounded-[20px] bg-white-A700 px-[53px] pb-[60px] pt-[53px] md:p-5">
                <Heading
                  size="md"
                  as="h1"
                  className="!text-[49.23px] !text-red-500_01"
                >
                  $25,000
                </Heading>
              </div>
              <div className="flex rounded-[20px] bg-white-A700 px-[53px] pb-[60px] pt-[53px] md:p-5">
                <Heading
                  size="md"
                  as="h2"
                  className="!text-[49.23px] !text-green-200"
                >
                  $14,000
                </Heading>
              </div>
              <div className="flex w-full justify-center rounded-[20px] bg-white-A700 px-[51px] pb-[62px] pt-[51px] md:p-5">
                <Heading
                  size="md"
                  as="h3"
                  className="!text-[49.23px] !text-black-900"
                >
                  $40
                </Heading>
              </div>
            ...
            <div className="flex items-center justify-between gap-5 sm:flex-col">
              ...
              <div className="flex w-[18%] items-center justify-center sm:w-full">
                <Text
                  size="lg"
                  as="p"
                  className="mb-[5px] self-end !text-[12.11px] !font-normal !text-black-900_01"
                >
                  Auto-Billing
                </Text>
