    ...
    >
      ...
      >
        <div className="flex flex-col gap-[13px]">
          <div className="relative h-[1072px]">
            <div className="absolute left-0 right-0 top-[0.00px] m-auto flex w-full">
              <MenuItem>Dashboard</MenuItem>
            </div>
            <div className="absolute right-[15.27px] top-[12%] m-auto flex flex-col justify-center pb-[61px] pt-[367px] md:py-5">
              <Img src="img_arrow_right_white_a700.svg" width={9} height={16} alt="arrow suffix" className="h-[16px]" />
            </div>
            <div className="absolute bottom-[-0.02px] left-0 right-0 m-auto w-full">
              <div className="flex flex-col gap-[13px]">
                ...
                <MenuItem
                  ...
                  suffix={
                    <div className="flex flex-col justify-center pb-[608px] md:pb-5">
                      <Img
          ...
          <div className="flex">
            <MenuItem
              icon={
                <Img src="img_search.svg" width={25} height={25} alt="search prefix" className="h-[25px] w-[25px]" />
              }
            >
              Settings
            </MenuItem>
